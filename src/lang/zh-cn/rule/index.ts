export default {
      ...
      "SupportCollation": 'create/alter 表或字段时允许的Collate范围。多个请使用逗号进行分割',
      "SupportCharset": 'create/alter 表或字段时允许的字符集范围。多个请使用逗号进行分割',
      ...
      "OSCExpr": '同步工具参数。如: PT-OSC 请注意! 此处仅填写参数。请使用以下变量名替换对应输入值 $SQL $ADDR $PORT $USER $PASSWORD $SCHEMA $TABLE。例子: (pt-osc配置) pt-online-schema-change  --alter $SQL --user=$USER  --password=$PASSWORD  --host=$ADDR P=$PORT,D=$SCHEMA,t=$TABLE  --execute',
