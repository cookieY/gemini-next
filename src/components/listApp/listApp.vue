<template>
      ...
      <br />
      <a-list :loading="loading" :data-source="source"
            :grid="{ gutter: 16, xs: 1, sm: 1, md: 2, lg: 2, xl: 4, xxl: 4, xxxl: 4 }" :pagination="pagination">
...
const handleChange = (value: string) => {
      (value === "" || value === undefined || value === "all") ? source.value = tmpSource : source.value = tmpSource.filter((item: RespFetchSource) => item.source === value)
};
