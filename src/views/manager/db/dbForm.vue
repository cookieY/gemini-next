...
const rules = {
      ...
      source: [{ required: true, message: t('db.check.name'), trigger: 'blur', }, { validator: regExp_Name, trigger: 'blur' }],
      ip: [{ required: true, message: t('db.check.addr'), trigger: 'blur' }],
      username: [{ required: true, message: t('db.check.username'), trigger: 'blur' }],
      port: [{ required: true, message: t('db.check.port'), trigger: 'blur', type: 'number' }],
      flow_id: [{ required: true, message: t('db.check.flow'), trigger: 'change' }],
      principal: [{ required: true, message: t('db.check.principal'), trigger: 'change' }],
      password: [{ required: true, message: t('db.check.password'), trigger: 'blur' }, { validator: regExp_password, trigger: 'blur' }]
}
